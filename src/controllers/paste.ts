...
export const getPaste = async(req, res, next) => {
    ...
    try {
        ...
        res.render('paste/pasteViewSingle', {id: paste._id, body: paste.body, description: paste.description})
    } catch (e) {
        next(e);
    }
}
...
export const getCreateNewPaste = (req, res, next) => {
    res.render('paste/pasteViewCreate')
}

// Uuden pasten luominen, ottaa vastaan POST requestin
export const postCreateNewPaste = async(req, res, next) => {
    ...
    try {
        ...
        res.render('paste/pasteViewSingle', {id: data._id, body: data.body, description: data.description})
